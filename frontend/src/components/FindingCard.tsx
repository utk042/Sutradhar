...
export default function FindingCard({finding}: {finding: Finding}) {
  ...
  return (
    <li className="ux4g-card ux4g-card-outline ux4g-mb-s">
      <div className="ux4g-card-body">
        <div className="ux4g-d-flex ux4g-ai-center ux4g-gap-s ux4g-mb-xs sutradhar-wrap">
          ...
          <span className="ux4g-heading-xxs-strong">{fieldLabel(tf, finding.field)}</span>
        ...
        <p className="ux4g-body-m-default ux4g-mb-s">{finding.explanation_en}</p>
